...
UNPRIVILEGED ACTOR GATES

Gate 1 — Not accepted or known design
Fails if the behavior is already accepted design per this protocol's own documentation, comments, or contest materials, or already appears in the program's known-issues list or a prior audit of this codebase. Also fails if it's a well-known, standard characteristic of this class of protocol in general, independent of whether this specific program's own docs say so anywhere.
...
PRIVILEGED ACTOR / NO-ACTOR GATES

Gate 1 — Not accepted or known design

Fails if the behavior is already accepted design per this protocol's own documentation, comments, or contest materials, or already appears in the program's known-issues list or a prior audit of this codebase. Also fails if it's a well-known, standard characteristic of this class of protocol in general, independent of whether this specific program's own docs say so anywhere.

Gate 2 — Exploitable / Honest use
...
Gate 3 — Loss or damage, not theft
